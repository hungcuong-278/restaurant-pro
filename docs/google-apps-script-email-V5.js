// ============================================================
//  ✅ PHIÊN BẢN V5 — CHỈ SỬA EMAIL TRONG NỘI DUNG (CONTENT)
//
...
const CONFIG = {
  ...
  // ✅ GIỮ NGUYÊN: Email khi người dùng bấm nút "Trả lời"
  REPLY_TO     : 'no-reply@hoinghitamthanhoctoanquoc.com',

  // ✅ GIỮ NGUYÊN: Email nhận thông báo có đăng ký mới
  ADMIN_EMAIL  : 'cuongvh006@gmail.com', 

  // ✅ MỚI: Email hiển thị trong nội dung thư để đại biểu liên hệ
  SUPPORT_EMAIL: 'bantochuc@hoinghitamthanhoctoanquoc.com',
...
<table width="600" cellpadding="0" cellspacing="0"
  ...
  <tr><td style="padding:40px;">
    ...
    <p style="margin:0 0 20px;font-size:14px;color:#6B7280;line-height:1.7;">
      ...
      <a href="mailto:${CONFIG.SUPPORT_EMAIL}" style="color:#0D3C1F; text-decoration: none; white-space: nowrap;"><strong>${CONFIG.SUPPORT_EMAIL}</strong></a></p>
  ...
  // Dùng MailApp thay vì GmailApp như bạn yêu cầu
  MailApp.sendEmail({
    to       : data.Email,
    subject  : subject,
    htmlBody : html,
