...
const CONFIG = {
  ...
  // replyTo: địa chỉ khi người nhận bấm "Trả lời" email xác nhận
  REPLY_TO     : 'no-reply@hoinghitamthanhoctoanquoc.com',

  // ✅ ĐÃ FIX LỖI 1: Bổ sung email cá nhân để nhận thông báo có đăng ký mới
  ADMIN_EMAIL  : 'cuongvh006@gmail.com', 
...
function testScript() {
  const fakeData = {
    ...
    Email            : 'cuongvh006@gmail.com',   // gửi về email này để kiểm tra (đóng vai người dùng)
