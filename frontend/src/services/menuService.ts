...
class MenuService {
  ...
  async getCategories(): Promise<MenuCategory[]> {
    try {
      const response = await api.get<APIResponse<MenuCategory[]>>('/menu/categories?restaurant_id=a8d307c4-40c2-4e11-8468-d65710bae6f3');
  ...
  async getMenuItems(filters: MenuFilters = {}): Promise<MenuResponse> {
    try {
      ...
      params.append('restaurant_id', 'a8d307c4-40c2-4e11-8468-d65710bae6f3');
